...
# Inlined from sklearn.feature_extraction._stop_words (BSD-3-Clause, Glasgow IRG list).
# Keeps tokenization identical to indexes built with sklearn stop words, without SciPy/scikit-learn.
